...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "AI for Beginners — Practical AI Skills" },
      { property: "og:description", content: "Live 4-week cohort. Real projects. Job-ready AI skills. KES 2,500 via M-Pesa." },
